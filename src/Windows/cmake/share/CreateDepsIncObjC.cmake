...
if( NOT OBJC_DEPS_INC)
   if( MULLE_SDE_REFLECT_DIR)
      set( OBJC_DEPS_INC "${CMAKE_CURRENT_SOURCE_DIR}/./${MULLE_SDE_REFLECT_DIR}/objc-deps.inc")
   else()
      set( OBJC_DEPS_INC "${CMAKE_CURRENT_SOURCE_DIR}/./reflect/objc-deps.inc")
   endif()
endif()
...
#   )
   ...
   # The preferred way:
   #
   # _1_MulleObjCWindowsFoundation is an object library (a collection of files).
   # _2_MulleObjCWindowsFoundation is the deps with OBJC_DEPS_INC.
   #
   # Produce a static library _3_MulleObjCWindowsFoundation from _1_MulleObjCWindowsFoundation
